...
contract MyEpicNFT is ERC721URIStorage {
    ...
    // WORD LOGIC
    string[] firstWords = ["Buildspace", "Coinbase", "Opensea", "Rarible", "Decentraland", "Lol"];

    string[] secondWords = ["Hodl", "Build", "Mooning", "Crpyto", "Yolo", "Ape"];

    string[] thirdWords = ["Amazing", "Mint", "Nft", "Culture", "Art", "Haha"];
    ...
    constructor() ERC721("BUIDLOOT", "BUIDLOOT"){
        console.log("This MyEpicNFT Contract Alive. WOW");
    }
